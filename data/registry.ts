    ...
    },
{
      ...
      country: "China",
      region: "Global",
      sector: "Manufacturing and IoT",
      website: "https://www.haier.com/",
      category: "Self-managing organization",
      theme: "RenDanHeYi, micro-enterprises, platform organization, and large-scale decentralization",
      sourceNote: "Starter profile based on public information and case literature about Haier's RenDanHeYi management model.",
      keywords: ["Haier RenDanHeYi", "micro enterprises", "self management", "decentralized organization", "platform organization"],
    },
    {
      name: "W. L. Gore and Associates",
      slug: "wl-gore",
      entityType: "Organization",
      country: "United States",
      region: "Global",
      sector: "Advanced materials and manufacturing",
      website: "https://www.gore.com/",
      category: "Self-managing organization",
      theme: "lattice organization, associate commitments, innovation culture, and alternatives to command-and-control management",
      sourceNote: "Starter profile based on public information from Gore and public writing about its lattice organization.",
      keywords: ["W. L. Gore lattice organization", "self organizing company", "lattice management", "associate culture", "innovation culture"],
    },
    {
      name: "Patagonia",
      slug: "patagonia",
    ...
    },
{
      ...
      country: "Spain",
      region: "Europe",
      sector: "Intentional community and ecovillage",
      website: "https://arterrabizimodu.org/",
      category: "Sociocratic ecovillage",
      theme: "sociocratic governance, shared land, transition culture, permaculture, and ecovillage living",
      sourceNote: "Starter profile based on Arterra's public project materials and academic research on its sociocratic governance.",
      keywords: ["Arterra Bizimodu", "sociocracy ecovillage", "ecovillage Navarra", "intentional community Spain", "regenerative community"],
    },
    {
      name: "Instituto Biorregional do Cerrado / Aldeia Aratikum",
      slug: "instituto-biorregional-do-cerrado",
      entityType: "Organization",
      country: "Brazil",
      region: "South America",
      sector: "Bioregional land stewardship and ecovillage",
      website: "https://ibccerrado.wixsite.com/ibcerrado",
      category: "Sociocratic land project",
      theme: "Aldeia Aratikum, Cerrado bioregional stewardship, sociocracy, permaculture, and intentional community",
      sourceNote: "Starter profile based on public IBC materials about Aldeia Aratikum and sociocratic governance.",
      keywords: ["Instituto Biorregional do Cerrado", "Aldeia Aratikum", "sociocracy Brazil", "bioregional land project", "permaculture ecovillage"],
    },
    {
      ...
      country: "United States",
      region: "North America",
      sector: "Justice-oriented agrarian community",
      website: "https://www.commonground.eco/",
      category: "Sociocratic land community",
      theme: "governance by peers, sociocracy, circles, consent decision-making, and agrarian community",
      sourceNote: "Starter profile based on Common Ground's public governance, story, and principles pages.",
      keywords: ["Common Ground Ecovillage", "governance by peers", "sociocracy", "agrarian community", "intentional community North Carolina"],
    },
    {
      ...
      country: "United States",
      region: "North America",
      sector: "Cohousing and intentional community",
      website: "https://www.cohousing.com/",
      category: "Sociocratic cohousing",
      theme: "cohousing governance, consensus-to-sociocracy transition, consent decision-making, and mature community life",
      sourceNote: "Starter profile based on public case writing about Pioneer Valley Cohousing's adoption of sociocracy.",
      keywords: ["Pioneer Valley Cohousing", "cohousing sociocracy", "consensus to sociocracy", "intentional community governance", "Amherst cohousing"],
    },
    {
...
export const directoryRecords: DirectoryRecord[] = [...starterProfileRecords];
